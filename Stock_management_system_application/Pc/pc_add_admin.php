...
Add Admin</center></font></h3><hr width="50%"><br />
<center>
<form action="addadmindb.php" method="GET">
...
<select name="sid">
  <option> Select one</option>
   <?php
                                            ...
                                            $qry="select distinct staffid from stock_management.login where staffid NOT IN(select staffid from stock_management.login where usertype='admin') order by staffid";
